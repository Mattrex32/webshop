...
<body>
    <header>
        <nav>
            <ul>
                    ...
                    <li class="active"><a href="winkelwagen.php"><img src="imgs/winkelwagen.png" alt="" height="40rem"></a></li>
            </ul>
    ...
    <main class="mainwinklewagen">
        <article class="e1">            
            <img src="imgs/tshirt articl.webp" alt="">
            <button>add</button>
        ...
        <article class="e5"></article>
        <article class="e6"></article>
        <article class="e7"></article>
    </main>
</body>
</html>